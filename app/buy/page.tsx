        ...
        {showPromo && (
          ...
          >
            <motion.div
              ...
              className="relative bg-[#12121a] border-2 border-emerald-500/60 rounded-2xl p-8 w-full max-w-md"
            >
              <button
              ...
              <p className="text-gray-500 text-xs text-center">You save $100.00 with this exclusive offer</p>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
