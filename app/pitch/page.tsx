        ...
        <main className="pt-16 pb-8 px-4 max-w-md mx-auto">
          ...
          >
            ...
            <div className="relative rounded-xl overflow-hidden h-40">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <svg width="32" height="32" viewBox="0 0 24 24" fill="#666" className="opacity-50">
                  <path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zM9 6c0-1.66 1.34-3 3-3s3 1.34 3 3v2H9V6z"/>
                </svg>
              </div>
            </div>
          ...
          >
            ...
            <div className="bg-[#0C1011] rounded-[22px] p-5 mb-4">
              ...
              <div className="bg-[#1A1A1A] rounded-xl py-4 mb-4">
                <p className="text-white text-center text-3xl font-bold">R$ 39<span className="text-xl">,90</span></p>
              </div>
