...
function PitchContent() {
  ...
  const purchaseLink39 = appendUtmToLink('https://go.centerpag.com/PPU38CQ5MBC');
  const purchaseLink59 = appendUtmToLink('https://go.centerpag.com/PPU38CQ5MBD');
  const purchaseLinkAllApps = appendUtmToLink('https://go.centerpag.com/PPU38CQ5MBB');
