        ...
        <main className="pt-20 pb-12 px-4 max-w-lg mx-auto">
          ...
          >
            ...
            <div className="text-center mb-6">
              ...
              <div className="w-12 h-0.5 mx-auto mt-2" style={{ background: 'linear-gradient(90deg, #2563EB, #3B82F6)' }} />
            </div>

            <div className="rounded-xl p-4 mb-5" style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.08)' }}>
              <p className="text-sm leading-relaxed" style={{ color: 'rgba(180, 200, 230, 0.6)' }}>
              ...
              <p className="text-sm leading-relaxed mt-3" style={{ color: 'rgba(180, 200, 230, 0.6)' }}>
