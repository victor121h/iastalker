    ...
    <div className="min-h-screen bg-black text-white p-4 pb-20">
      <div className="w-full max-w-md mx-auto space-y-3">
        ...
        >
          ...
          <h1 className="text-white font-bold text-lg">SMS Monitor</h1>
          <div className="w-12" />
        </motion.div>
        ...
        >
          <p className="text-yellow-400 text-xs font-bold tracking-wider mb-2">SCAN COMPLETED</p>
          <h2 className="text-white text-xl font-bold mb-1">Classified Messages</h2>
          <p className="text-gray-400 text-sm mb-4">
            Suspicious messages detected on the target device.
          </p>
          <div className="grid grid-cols-3 gap-2">
            <div className="bg-[#0d1a0d] border border-yellow-500/30 rounded-xl p-3 text-center">
              <p className="text-yellow-400 text-[10px] font-bold uppercase">Suspicious</p>
            ...
            <div className="bg-[#1a0d1a] border border-purple-500/30 rounded-xl p-3 text-center">
              <p className="text-purple-400 text-[10px] font-bold uppercase">Night Messages</p>
                    ...
                    >
                      <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-3">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className="text-red-400 font-bold text-xs">Access Blocked</span>
                        </div>
                        <p className="text-red-300 text-xs">
                          The phone carrier server blocked access to this user's messages. Direct connection was denied.
                        </p>
                      </div>

                      <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-3">
                        <p className="text-yellow-300 text-xs">
                          A proxy connection is required to access the carrier's anonymous servers and bypass the block.
                        </p>
                      </div>
                      ...
                      <a
                        ...
                        className="flex items-center justify-center gap-2 w-full py-3 rounded-xl font-bold text-white text-center text-sm bg-gradient-to-r from-yellow-600 to-orange-600 hover:opacity-90 transition-opacity"
                      >
                        <span>🔓</span> Unlock Proxy Access
                      </a>
                    </motion.div>
                  )}
                </AnimatePresence>
