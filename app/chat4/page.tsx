        ...
        >
          {unlocking ? (
            ...
            <>
              ...
              <span className="text-white font-bold text-sm md:text-base">Unlock another conversation about this subject for 550 credits</span>
      ...
      <div className="flex-1 pt-[116px] pb-[70px] px-4 overflow-y-auto">
        <div className="max-w-3xl mx-auto py-6 space-y-6">
          ...
          <div className="flex justify-end">
            <div className="max-w-[60%]">
              <div className="bg-gradient-to-r from-[#8740FF] to-[#B768FF] rounded-2xl rounded-br-md px-4 py-3">
                <p className="text-white text-[15px]">I need to tell you something but you have to promise you won't tell anyone</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-start">
            <div className="flex items-end gap-2 max-w-[60%]">
              ...
              <div className="bg-[#1B1F23] rounded-2xl rounded-bl-md px-4 py-3">
                <p className="text-white text-[15px]">Ok what happened? You're scaring me</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-end">
            <div className="max-w-[60%]">
              <div className="bg-gradient-to-r from-[#8740FF] to-[#B768FF] rounded-2xl rounded-br-md px-4 py-3">
                <p className="text-white text-[15px]">I kissed <BlurredText text="someone" />... {displayName} can never find out about this</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-start">
            <div className="flex items-end gap-2 max-w-[60%]">
              ...
              <div className="bg-[#1B1F23] rounded-2xl rounded-bl-md px-4 py-3">
                <p className="text-white text-[15px]">WHAT?! Are you serious right now?? 😱</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-end">
            <div className="max-w-[60%]">
              <div className="bg-gradient-to-r from-[#8740FF] to-[#B768FF] rounded-2xl rounded-br-md px-4 py-3">
                <p className="text-white text-[15px]">Yes... it just happened, I don't know what to do. {displayName} trusts me so much</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-start">
            <div className="flex items-end gap-2 max-w-[60%]">
              ...
              <div className="space-y-2">
                <div className="bg-[#1B1F23] rounded-2xl rounded-bl-md px-4 py-3">
                  <p className="text-white text-[15px]">You need to tell {displayName} the truth. This is going to <BlurredText text="destroy everything" /></p>
                </div>
                <AudioMessage isReceived={true} duration="0:47" onClick={showNotification} />
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-end">
            <div className="max-w-[60%]">
              <div className="bg-gradient-to-r from-[#8740FF] to-[#B768FF] rounded-2xl rounded-br-md px-4 py-3">
                <p className="text-white text-[15px]">No! {displayName} can NEVER know. Please <BlurredText text="keep this between us" /> 🙏</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-start">
            <div className="flex items-end gap-2 max-w-[60%]">
              ...
              <div className="bg-[#1B1F23] rounded-2xl rounded-bl-md px-4 py-3">
                <p className="text-white text-[15px]">This is so wrong... <BlurredText text="I don't know if I can keep this secret" /> 😔</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-end">
            <div className="max-w-[60%]">
              <AudioMessage isReceived={false} duration="2:03" onClick={showNotification} />
            </div>
          </div>
          ...
          <div className="flex justify-start">
            <div className="flex items-end gap-2 max-w-[60%]">
              ...
              <div className="bg-[#1B1F23] rounded-2xl rounded-bl-md px-4 py-3">
                <p className="text-white text-[15px]">{displayName} deserves to know. You're being <BlurredText text="selfish" /></p>
              </div>
            </div>
          </div>
