      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4 py-12">
        ...
        >
          <div className="flex justify-center mb-6">
            <div className="w-[60px] h-[60px] bg-[#4A90D9] rounded-xl flex items-center justify-center">
          ...
          <p className="text-[#666666] text-base mb-6 leading-relaxed">
            Our app is hosted in France, and you live in another country. A currency exchange fee of <span className="font-bold text-[#4A90D9]">$67.90</span> is required for IA Observer to be allowed to operate in your region.
          </p>
