  ...
  const plans = [
    {
      ...
      badgeColor: 'bg-[#00FF75] text-black',
    ...
    },
    {
      ...
      badgeColor: 'bg-[#FA7E1E] text-white',
      borderColor: 'border-[#FA7E1E]',
      price: '49.90',
      oldPrice: '120.00',
      savings: '90.10',
      access: 5,
      ...
      <div className="relative z-10">
        ...
        <main className="pt-20 pb-12 px-4 max-w-lg mx-auto">
          ...
          >
            ...
            <div className="mb-6">
              <p className="text-sm text-center mb-2 text-[#808080]">Step 2 of 3 - Activate your plan</p>
              <div className="w-full rounded-full h-2.5 overflow-hidden bg-[#1a1a1a]">
                <div
            ...
            <div className="rounded-xl p-4 mb-4" style={{ background: 'rgba(214, 41, 118, 0.1)', border: '1px solid rgba(214, 41, 118, 0.3)' }}>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 flex items-center justify-center flex-shrink-0">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="#D62976">
                    <path d="M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z"/>
                  </svg>
                </div>
                <p className="text-white text-sm">
                  <span className="font-bold" style={{ color: '#D62976' }}>IMPORTANT:</span> If your plan is not activated now, you won&apos;t be able to spy on any profile.
                </p>
              </div>
            </div>

            <div className="rounded-xl p-4" style={{ background: 'rgba(250, 126, 30, 0.1)', border: '1px solid rgba(250, 126, 30, 0.3)' }}>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 flex items-center justify-center flex-shrink-0">
                  <span className="text-lg">⚠️</span>
                </div>
                <p className="text-white text-sm">
                  <span className="font-bold" style={{ color: '#FA7E1E' }}>Attention!</span> Not activating one of the plans will result in the disclosure of your spying. That&apos;s right, if you don&apos;t activate the plan, we will expose that you spied on the person.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          <div className="space-y-5">
            {plans.map((plan, index) => (
              ...
              >
                <div className={`absolute top-3 right-3 ${plan.badgeColor} text-xs font-bold px-3 py-1 rounded-full`}>
                  {plan.badge}
                </div>
          ...
          >
            ...
            <div className="flex justify-center mb-4">
              <div
                ...
                style={{ background: 'linear-gradient(135deg, #D62976 0%, #FA7E1E 100%)' }}
              >
                <span>⚡</span>
            ...
            <p className="text-sm text-center mb-5 text-[#A0A0A0]">
            ...
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <div className="text-center">
                <span className="text-sm" style={{ color: '#FA7E1E' }}>For</span>
                <p className="text-4xl font-bold" style={{ color: '#FA7E1E' }}>$49.90</p>
              </div>
            </div>
            ...
            <div className="mb-5">
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
                {['Unlimited profile search', '24h GPS', 'Total anonymity', 'Complete history', 'Real-time notifications', 'WhatsApp Spy', 'Hidden gallery', 'Multiple targets'].map(item => (
                  <div key={item} className="flex items-center gap-2 text-[#A0A0A0]">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="#D62976"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z"/></svg>
                    <span>{item}</span>
                  </div>
                ))}
              </div>
            ...
            <p className="text-xs text-center mb-3 text-[#666]">
            ...
            <button
              onClick={closePopup}
              className="text-xs text-center w-full underline transition-colors text-[#666] hover:text-[#A0A0A0]"
            >
