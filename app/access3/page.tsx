...
function VideoPlayer() {
  ...
  useEffect(() => {
    ...
    setVideoSrc(`https://scripts.converteai.net/0bf1bdff-cfdb-4cfd-bf84-db4df0db7bb2/players/69765000626926f624b2b652/v4/embed.html${search}&vl=${vl}`);
  }, []);

  if (!videoSrc) return (
    <div id="ifr_69765000626926f624b2b652_wrapper" style={{ margin: '0 auto', width: '100%', maxWidth: '400px' }}>
      <div style={{ position: 'relative', padding: '177.78% 0 0 0' }} id="ifr_69765000626926f624b2b652_aspect">
    ...
    <div id="ifr_69765000626926f624b2b652_wrapper" style={{ margin: '0 auto', width: '100%', maxWidth: '400px' }}>
      <div style={{ position: 'relative', padding: '177.78% 0 0 0' }} id="ifr_69765000626926f624b2b652_aspect">
        <iframe
          ...
          allowFullScreen
          src={videoSrc}
          id="ifr_69765000626926f624b2b652"
...
function Access3Content() {
  ...
  const handleSearch = async () => {
    ...
    if (cleanUsername) {
      ...
      const base = `/access3?username=${encodeURIComponent(cleanUsername)}`;
      ...
      <AnimatePresence>
        {showVerifyPopup && (
          ...
          >
            ...
            <a
              href={appendUtmToLink('https://go.centerpag.com/PPU38CQ6TOB')}
      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          <h2 className="text-white font-bold text-lg mb-4 flex items-center gap-2">
            ...
            Profiles followed by {profile?.username || 'this profile'}
          </h2>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-purple-900/30 border border-purple-500/30 rounded-lg p-3 mb-4">
                  <p className="text-purple-300 text-sm">
                    Full direct messages will appear after our team installs AI Observer on your phone.
                  </p>
                </div>
        ...
        {showHelpPopup && (
          ...
          >
            ...
            >
              {!helpSubmitted ? (
                <>
                  <h2 className="text-white text-xl font-bold mb-4">Get Help</h2>
...
export default function Access3Page() {
  return (
