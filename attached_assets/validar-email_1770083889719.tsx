import { ArrowLeft, Zap, Check, X, Trash2, Loader2, RefreshCw } from "lucide-react";
...
export default function ValidarEmail() {
  ...
  const handleAcelerar = () => {
    ...
    // Navigate to processing page with countdown
    setLocation(`/processando-relatorio/${username}`);
  };
